...
gaussian_noise_config = dnnlib.EasyDict(
    ...
    train_stddev_rng_range=(0.0, 100.0),
    validation_stddev=50.0
)
poisson_noise_config = dnnlib.EasyDict(
    func_name='train.AugmentPoisson',
    lam_max=50.0
)
gaussian_blur_config = dnnlib.EasyDict(
    func_name='train.AugmentGaussianBlur',
    size_kernel = 5,
    train_stddev_rng_range=(0.0, 1.0),
    validation_stddev=0.5
)
fblur_config = dnnlib.EasyDict(
    func_name='train.AugmentBlur',
    size_kernel = 5,
    train_stddev_rng_range=(0.0, 1.0),
    validation_stddev=0.5
)
superresolution_config = dnnlib.EasyDict(
    func_name='train.AugmentSuper',
...
corruption_types = {
    ...
    'gblur': gaussian_blur_config,
    'super': superresolution_config,
    'fftblur': fblur_config
}
